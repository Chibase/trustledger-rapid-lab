...
const initialProject: AssessmentProject = {
  name: "",
  type: "",
  location: "",
  stage: "",
...
export default function AssessmentPage() {
  const [project, setProject] =
    useState<AssessmentProject>(initialProject);

  function updateField(
    field: keyof AssessmentProject,
    value: string,
  ) {
    setProject((current) => ({
      ...current,
  ...
  window.location.href = "/assessment/questions/stakeholder_coverage";
}
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-10">
          ...
          <p className="mt-3 text-slate-600">
            Start by providing basic information about the project being
            assessed.
          </p>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-slate-300 px-4 py-3 outline-none focus:border-slate-900"
                placeholder="e.g. Project Manager, Social Facilitator"
              />
            </div>
          </div>
